...
const BatchVideoUploader = ({
  onUploadComplete,
  maxSizeMB = 50,
  className,
}: BatchVideoUploaderProps) => {
  ...
  const batchUpload = useBatchUpload({
    ...
    chunkSize: 2, // Smaller chunk size for videos
    maxRetries: 3,
    retryDelay: 3000, // Longer delay for videos
    ...
    <div className={cn('space-y-4', className)}>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium mb-1">Drop videos here or click to browse</p>
            <p className="text-xs text-muted-foreground">
              MP4, WebM, MOV • Max {maxSizeMB}MB each • Select multiple
            </p>
          </div>
